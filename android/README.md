...
GitHub Actions 使用 Temurin JDK 17、官方 `gradle/actions/setup-gradle` 和仓库内 Wrapper，无需全局安装 Gradle。每次推送 `Android_beta` 后，Actions 会上传保留 14 天的 `Localis-Android-beta-<commit>` 安装包与 SHA-256 文件。
